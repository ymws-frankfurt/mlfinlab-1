"""
Standalone profiling script for EF3M - imports only the necessary module.
"""
...
# Import the EF3M module directly by loading the file
sys.path.insert(0, '/app/scripts/jmrichardson_mlfinlab/mlfinlab/bet_sizing')
import ef3m
